        ...
        <div class="h-full px-6 text-neutral-800 dark:text-neutral-200">
            ...
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
              ...
              <div class="mb-6">
                ...
                <input v-model="registerData.first_name" type="text" id="first-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="First Name" required>
              </div> 

              <!-- Last name input -->
              <div class="mb-6">
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                <input v-model="registerData.last_name" type="text" id="last-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Last Name" required>
              </div> 
                ...
                <div class="text-center lg:text-left">
                    ...
                    class="inline-block rounded bg-midnight px-7 pt-3 pb-2.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
                    data-te-ripple-init
                    data-te-ripple-color="light">
                    Register
                    </button>
...
<script>
  export default {
    ...
    data() {
        return {
        haveError: false,
        errorText: "Incorrect Password or Email, Please try again.",
        registerData: {}
      }
    },
    methods: {
      registerUser(){
        if(this.registerData.email && this.registerData.password){
          let data = JSON.stringify(this.registerData)
          console.log(data)
          axios.post(`${this.$hostname}/api-auth/register-user`, data, {
            headers: {
              'Content-Type': 'application/json'
            }
          }).then((response) => {
